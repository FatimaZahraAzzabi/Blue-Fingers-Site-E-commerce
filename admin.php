...
<head>
  ...
  <title>Formulaire d'admin</title>
...
<body>
  <div id="container">
    <form action="verif.php" method="POST">
      ...
      <label><b>Nom d'admin</b></label>
      <input type="text" placeholder="Entrer le nom complet" name="adminname" required>
      ...
      <input type="submit" id='submit' name="subad" value='LOGIN'>
    </form>
  </div>
